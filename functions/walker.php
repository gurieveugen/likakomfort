...
class Custom_Walker_Nav_Menu extends Walker {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if(in_array($item->object_id, $all_cat)) $classes[] = 'current-menu-item';
	...
	{
		$term = $this->get_term_by_id_only($term_id);
		array_push($parents, $term->term_id);
		if($term->parent != 0) return $this->getAllParents($term->parent, $parents);		
		return $parents;
	}
